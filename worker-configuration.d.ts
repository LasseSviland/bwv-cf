/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b10bf6a6b27cbe70d57d43633ec78b14)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	API_KEY: string;
	VINMONOPOLET_OPEN_API_KEY: string;
	VINMONOPOLET_RESTRICTED_API_KEY: string;
}
